...
LaperBang is not designed as a social media application.

The follow feature does not represent a social relationship.

Instead:

Following a vendor means:

> "I want to receive realtime updates from this vendor."


The goal is to create a lightweight realtime demand and supply connection between customers and mobile vendors.
## Responsibilities
