...
heroImage: "@/content/work/laperbang/banner.png"
category:
  - "Side Project"
  - "Geospatial System"
  - "Real-Time Platform"
...
import Overview from "@/content/work/laperbang/overview.png"
import EmbeddedPresentation from "@/components/ui/EmbeddedPresentation.astro"
import { Image } from "astro:assets"

<Banner title="Disclaimer">
   You can see a whole article talking about the detailed architecture of LaperBang <a href="/blog/2026/june/how-i-built-laper-bang-backend-architecture/" target="_blank" rel="noopener noreferrer">HERE</a>, but I will focus more on general brief in this section.
</Banner>
